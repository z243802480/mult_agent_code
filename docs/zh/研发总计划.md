...
**版本**：1.1.0
**状态**：current — 长期执行入口（2026-06-08 校正）
...
`execute_command.py`, `run_command.py`, orchestration gray/DecisionPoint、acceptance/real_model 栈。仅允许为 S74 基线失败、真实 Beta 证据或明确契约漂移做聚焦修复。
