...
## 7. Chat / Goal ???????2026-05-24?

???????????????????????? `chat` ?????????/?????? Claude Code / Codex ????????????????????????????????????????????????????????????????????

?????

1. **Chat ????????????????**??????? chat???????????/??/??/??/????????chat ????? plan ? goal/run?
2. **Plan ??????**???????????????????????/??????? plan?????????????
3. **Goal/Run ??????**??????????????????????????? goal/run????? policy?DecisionPoint?evidence?review?accept?
4. **???????????**????????? chat/plan/run/review/resume???????????
5. **???????????**?????????????????????????????????????? policy gate ???
6. **???????????**??? chat ??????????????? plan/run ????????????

Claude-style ????Claude Code ????????????????????????????????? bug??????????????????????????????????Asteria ?????????? runtime evidence?goal_policy?DecisionPoint ? final review/accept ????
...
runtime/status/model-route question
  -> chat
ordinary Q&A
  -> chat
workspace-changing task + permission allow
  -> run
workspace-changing task + permission ask/balanced
  -> plan first
...
?????????????????? `IntentRoute`??? `intent`?`target_mode`?`confidence`?`permission_pressure`?`risk_reason`?`recommended_next_action`????? session evidence?????????????????????
