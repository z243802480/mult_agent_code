...
1. 总耗时（分钟）
2. 第一次看到系统真正执行动作大约用了多久
3. 最长一次没有新反馈的等待大约多久，当时是否知道系统正在做什么
4. A/B/C 哪些步骤未完成，卡住时是否理解下一步
5. Inspector 是否帮助你确认系统真的调用了工具、修改了文件或完成了验证
6. 最难的一步（一句话）
7. D1–D5 若有卡点，标注 **diff / context / session / side_ask**
8. 是否愿意再试第二个任务
