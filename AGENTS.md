...
当前 ACTIVE_SLICE：G17 图片附件（1.2.96/1.2.98）、自审 8/8 角度（1.2.97/1.2.99/1.2.100）、索引虚构纠正（1.2.101）均已收官。G18 已判「不做·等证据」。下一刀待定。

**本段是索引，不是记账。细节一律去真源查，勿在此复述**（复述会漂，已犯过：见 1.2.95）：
- 执行计划 + 逐刀 changelog（**唯一真源**）：`docs/zh/研发总计划.md` §16 / §16.1 / changelog 1.2.30–1.2.101
