...
class ExecuteCommand:
    ...
    def _model_driven_prompts(
        ...
        system_prompt = (
            ...
            "- Disclose broken assumptions: if the task presupposes something that is NOT true — a "
            "file it says to EDIT that does not exist, a function it says to EXTEND that is missing — "
            "do not silently pretend you edited it. Say plainly in your narration and final answer "
            "that it was missing and you created it new, so the user is not misled into thinking "
            "other code (e.g. sibling commands) still lives there.\n"
