...
import { buildRouteMessageWithChatContext } from "./lib/chat-route-context.mjs";
...
// consts or hoisted server functions. Only the five names startChatJob drives come back out.
const {
  buildChatAnswer,
  readChatContext,
  sideAskContextHint,
