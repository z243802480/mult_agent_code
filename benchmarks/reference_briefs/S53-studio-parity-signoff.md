...
- [x] `pytest tests/unit/test_documentation_contracts.py -q` 全绿
- [x] 全 Studio smoke bundle（见 closure plan §5）
- [x] ACTIVE_SLICE 更新为 F2（S54）
- [x] AGENTS.md / 研发总计划 §16 / vibe_slices active_slice 三源一致
